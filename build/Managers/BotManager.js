...
var TempUser_1 = __importDefault(require("../TempUser"));
...
var GroupData = require('../group-data.json');
var BotManager = (function () {
    ...
    BotManager.prototype.BusesMessage = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this._bot.sendMessage(message.chat.id, StaticStrings["message-buses"])];
                    case 1:
                        _a.sent();
                        return [2, this.StartingMessage(message)];
                }
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4, this._client.WeekList(user.getGroup())];
                    case 1:
                        _a._weeklistCache = _f.sent();
                        _c = (_b = this._bot).sendMessage;
                        _d = [message.chat.id, StaticStrings["message-weekSelection"]];
                        _e = {};
                        return [4, DynamicKeyboards.AllWeeks(this._weeklistCache)];
                    case 2: return [2, _c.apply(_b, _d.concat([(_e.reply_markup = _f.sent(),
                                _e)]))];
                }
            });
        });
    };
    BotManager.prototype.SendWeekView = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _c = [message.chat.id];
                        return [4, this._client.WeekView(this._users.get(message.chat.id).getWeekViewRequest())];
    ...
    BotManager.prototype.SyncUserData = function (messageType, message) {
        return __awaiter(this, void 0, void 0, function () {
            var user, week;
            return __generator(this, function (_a) {
                user = this._users.get(message.chat.id);
                if (user !== undefined) {
                    switch (messageType) {
                        case MessageTypeEnum_1.MessageTypeEnum.FacultySelected:
                            user.setStage(TimetableStages_1.TimetableStages.FacultySelected);
                            break;
                        case MessageTypeEnum_1.MessageTypeEnum.GroupSelected:
                            user.setGroup(GroupData[message.text]);
                            user.setStage(TimetableStages_1.TimetableStages.GroupSelected);
                            break;
                        case MessageTypeEnum_1.MessageTypeEnum.WeekSelected:
                            week = this._weeklistCache.filter(function (x) { return x.weekTitle == message.text; })[0];
                ...
                this._users.set(message.chat.id, new TempUser_1.default());
                return [2];
            });
        });
    };
